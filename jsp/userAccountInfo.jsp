...
<li ><a href="/eAuction/LoginSystem?param=userHome">Home</a></li>
</ul>
</div>
<div id="bodyPanel">
...
<tr valign="top" >
	...
	<td>
		<fieldset style="border-color: #e2e2e2">
			<legend style="font-size: 18pt; color: #123456; font-weight: bold; font-family: arail">Users Bank Account Info</legend>
		</fieldset>
	</td>
</tr>
</table>
