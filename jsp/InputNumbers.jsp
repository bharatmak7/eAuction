...
<tr valign="top" >
	...
	<td>
		<fieldset style="border-color: #e2e2e2">
			...
			<br/>
			<font size="5" color="red">Your Region Id Is : <%=regnId %></font> <br/>
			<font size="5" color="red">Your vehicle Class Is : <%=vehClass %></font> <br/>
			<font size="5" color="red">Your Vehicle Number Is : <%=vehNumber %></font>
		</fieldset>
	</td>
</tr>
</table>
